...
<div class="panel panel-default">
	<div class="panel-heading">当前版本 <?php echo $this->app->params['version']; ?> 该后台管理系统供<b><?php echo Yii::app()->name; ?></b>使用！</div>
	...
	<ul class="list-group">
		...
		<li class="list-group-item">数据库信息： <font color="blue"><?php echo $this->app->db->connectionString.'/'.Yii::app()->db->serverVersion; ?></font></li>
		...
		<li class="list-group-item">上传目录是否可写： <font color="blue"><?php echo is_writable(Yii::getPathOfAlias('webroot').'/upload') ? '可写' : '不可写'; ?></font></li>
