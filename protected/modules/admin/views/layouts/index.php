...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" target="_blank" href="<?php echo $this->app->homeUrl; ?>"><?php echo CHtml::encode($this->app->name)?></a>
		</div>
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav" id="nav"><?php echo $content; ?></ul>
			<ul class="nav navbar-nav navbar-right">
				<li>
                    <a class="self-edit" href="<?php echo $this->createUrl('account/edit', array('id'=> $this->user->getId())); ?>">
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-xs-10 col-sm-10 col-md-10 col-xs-offset-2 col-sm-offset-2 col-md-offset-2 main" id="content"></div>
	</div>
</div>
<?php $this->endContent(); ?>